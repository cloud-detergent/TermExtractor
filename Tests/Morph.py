...
class TestMorphy(unittest.TestCase):
    ...
    def test_collocation_separator_tags(self):
        ...
        expected_results = [
            TaggedWord(word='направление', pos=PartOfSpeech.noun, case=Case.nominative, normalized='направление'),
    ...
    def test_collocation_tag(self):
        ...
        sentences = [
            'Минометный батальон (дивизион) является мощным огневым средством пехоты во всех видах ее боевой деятельности',
            'Основная задача его заключается в непосредственной поддержке стрелковых рот и сопровождении их огнем и движением']
        expected_results = [
            [TaggedWord(word='Минометный', pos=PartOfSpeech.adjective, case=Case.nominative, normalized='миномётный'),
            ...
            [TaggedWord(word='Основная', pos=PartOfSpeech.adjective, case=Case.nominative,
             ...
             TaggedWord(word='сопровождении', pos=PartOfSpeech.noun, case=Case.prepositional,
                        normalized='сопровождение'),
